...
HOW THE GAME WORKS: 
Your computer starts with 0 KB, and as you click, you can spend bits to upgrade it and gain more bits. As you progress, you go from kb -> mb -> gb -> tb.
The shop changes based on your bit type, so the game gets harder as you gain more bits. 
...
Regarding my commits for Hack Club, I didn't even know abt linking VS to GitHub and committing until I was almost done with the project, so I'm really sorry if there are only like 6 commits. 
I hope I can still get the hours I worked on this project because I really did work those hours, even if my commits don't show it. 
Thank you, Hack Club Reviewer. 
